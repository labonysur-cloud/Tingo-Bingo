        ...
        <div className="min-h-screen bg-white pb-24">
            ...
            <div className="p-6 max-w-lg mx-auto">
                <div className="flex flex-col items-center text-center mb-8">
                    <div className="w-20 h-20 bg-gradient-to-tr from-secondary to-primary rounded-3xl flex items-center justify-center text-white font-bold text-4xl shadow-xl mb-6 transform rotate-3">
                        t
                    </div>
